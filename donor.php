            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <nav class="navbar navbar-inverse">
                            ...
                            <ul class="nav navbar-nav" align="right" style="float: right;">
                               ...
                               <li  class="active"><a href="donor.php"><font style="color:red;font-family: arial;">Donor Registration</font></a></li>                                
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-lg-7">
                            <br />
                            <h1 style="color:red; font-family: arial;"><center><b>Donor Registration Form</b></center></h1>
                           <br />
                           <br />
                           ...
                           <center>
                            ...
                            <table class="table table-bordered table-responsive" width="50%">
                                ...
                                <tr>
                                <td>Contact No</td>
                                <td><input type="text" name="cno" id="cno" onkeyup="return validcno();" class="form-control" required="required" maxlength="10" /></td>
                            </tr>
                            <tr>
                                    <td>Email Id</td>
                                ...
                                <tr>
                                   <td>Are you physically well-fit for the blood donation ?</td>
                                   <td><input type="radio" name="vir" value="Yes" required="required" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="vir" value="No" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No</td>  
                                </tr>
                                <tr>
 ...
 <option value="B-">B-</option>
  ...
  <option value="O-">O-</option>
                               ...
                               if(isset($_POST['sub1']))
                   {
                       ...
                       $g=$_POST['vir'];
                       $k=$_FILES['pics']['name'];
                       $q=  move_uploaded_file($_FILES['pics']['tmp_name'],getcwd()."//pic//$k");
                       $i=$_POST['grp'];
                       $j=$_POST['otp'];
                   $ins=  mysql_query("insert into donor_reg values('','$a','$b','$c','$c1','$d','$e','$f','$g','$k','$i','$j')");
                    $in=  mysql_query("insert into login values('','$c1','$j','donor','1')");
                  if($ins>0)
                   {
                        if($in>0)
                        {
