                        ...
                        <nav class="navbar navbar-inverse">
                            <div class="container-fluid">
                              <ul class="nav navbar-nav" align="right" style="float: right;">
                                  <li  class="active"><a href="requesterhome.php"><font style="color:red;font-family: arial;">Home</font></a></li>
...
The fluid is used to measure different substances in the blood. "We Care" provides you a complete health care solutions for your blood, And also we helps the users who wood like to donate their blood and also helps the people who are seeking for a perfect blood donor.  
                        </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="alert alert-danger">
