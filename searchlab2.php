...
function showHints(str) {
                        ...
                        <nav class="navbar navbar-inverse">
                           ...
                           <ul class="nav navbar-nav" align="right" style="float: right;">
                               <li><a href="userhome.php">Home</a></li>
                                  <li class="active"><a href="searchlab2.php" style="color:red;">View Labs</a></li>   
   ...
   while($r1=  mysql_fetch_row($s))
   {
    ...
    <tr align="center">
         ...
         <td><?php echo $r1[4] ?></td>
         <td><?php echo $r1[3] ?></td>
         <td><a href="viewlab2.php?t=<?php echo $r1[0] ?>"><span class="btn btn-success" >view more</span></a></td>
        </tr>
        </table>
