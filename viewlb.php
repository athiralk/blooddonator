...
function showHints(str) {
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="banner">
                            <img src="Images/Banner.jpg" class="img img-responsive" />
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <nav class="navbar navbar-inverse">
                            ...
                            <ul class="nav navbar-nav" align="right" style="float: right;">
                                  ...
                                  <li class="active"><a href="viewlb.php"style="color:red;">Search Labs</a></li> 
                                   <li><a href="viewlbs.php" >Labs Details</a></li> 
    ...
    <form method="POST" enctype="multipart/form-data"> 
        ...
        $se=  mysql_query("select * from usrreg");
   ...
   while($r1=  mysql_fetch_row($s))
   {
    ...
    <tr align="center">
         ...
         <td><?php echo $r1[4] ?></td>
         <td><?php echo $r1[3] ?></td>
         <td><a href="viewlab.php?t=<?php echo $r1[0] ?>"><span class="btn btn-success" >view more</span></a></td>
        </tr>
        </table>
