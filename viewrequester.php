            ...
            <div class="container">
                <div class="row">
                          ...
                          <ul class="nav navbar-nav" align="right" style="float: right;">
                              <li><a href="adminhome.php">Home</a></li>
                                  <li><a href="viewdonor.php">View Donors</a></li> 
                                     <li class="active"><a href="viewrequester.php"><font style="color:red;font-family: arial;">View Requesters</font></a></li> 
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="col-lg-6">
                            <br />
                            <center> <span class="btn btn-danger" style="width:550px;"><font size="14">List Of Requesters..</font></span></center>
                                ...
                                <table class="table table-bordered table-condensed table-hover table-responsive table-striped ">
                                      <tr>
                                        ...
                                        <?php
                                        $sel=mysql_query("select * from req_reg");
